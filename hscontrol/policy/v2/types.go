...
type Policy struct {
	...
	// Grants are application-capability rules (taildrop, taildrive, etc.).
	// See hscontrol/policy/v2/grants.go.
	Grants Grants `json:"grants,omitempty"`

	// NodeAttrs are per-node attribute assignments merged into the
	// Tailscale NodeCapMap. See hscontrol/policy/v2/grants.go.
	NodeAttrs NodeAttrs `json:"nodeAttrs,omitempty"`
	// __END_CYLONIX_MOD__
}

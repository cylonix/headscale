...
var _UserViewNeedsRegeneration = User(struct {
	gorm.Model
	Name               string
	LoginName          *string // __CYLONIX_ADD__
	Namespace          *string // __CYLONIX_ADD__
	Network            string  // __CYLONIX_ADD__
	DisplayName        string
	Email              string
...
func (v NodeView) StableID() views.ValuePointer[string] {
	return views.ValuePointerOf(v.ж.StableID)
}

func (v NodeView) Namespace() string     { return v.ж.Namespace }
func (v NodeView) NetworkDomain() string { return v.ж.NetworkDomain }

func (v NodeView) CapVersion() views.ValuePointer[uint32] {
	return views.ValuePointerOf(v.ж.CapVersion)
}

func (v NodeView) Capabilities() views.Slice[Capability] {
	return views.SliceOf(v.ж.Capabilities)
}

func (v NodeView) Health() views.ValuePointer[string] {
	return views.ValuePointerOf(v.ж.Health)
}

func (v NodeView) IsJailed() bool { return v.ж.IsJailed }

func (v NodeView) WouldShareTo() views.Slice[User] {
	return views.SliceOf(v.ж.WouldShareTo)
}

func (v NodeView) AcceptedShareTo() views.Slice[User] {
	return views.SliceOf(v.ж.AcceptedShareTo)
}
...
var _PreAuthKeyViewNeedsRegeneration = PreAuthKey(struct {
	...
	Namespace   string // __CYLONIX_ADD__
	IPv4        string // __CYLONIX_ADD__
	IPv6        string // __CYLONIX_ADD__
	Description string // __CYLONIX_ADD__
}{})

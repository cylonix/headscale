...
// __BEGIN_CYLONIX_ADD__ Counts updates buffered by the connection readiness
// gate (connectionEntry.ready in batcher_lockfree.go). Nonzero under
// reconnect churn proves the initial-map race was being hit, with no
// client-visible effect.
var mapResponsePreReadyBuffered = promauto.NewCounter(prometheus.CounterOpts{
	Namespace: "headscale",
	Name:      "mapresponse_pre_ready_buffered_total",
	Help:      "total count of mapresponses buffered before the initial full map was enqueued",
})

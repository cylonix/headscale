...
var file_headscale_v1_headscale_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb2, 0x1d, 0x0a,
	...
	0x73, 0x12, 0x6c, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x12,
	...
	0x2f, 0x76, 0x31, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x2f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12,
	0x6f, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x1f, 0x2e,
	0x68, 0x65, 0x61, 0x64, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20,
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70,
	...
	,
...
var file_headscale_v1_headscale_proto_goTypes = []any{
	...
	(*CreateNodeRequest)(nil),        // 18: headscale.v1.CreateNodeRequest
	(*UpdateNodeRequest)(nil),        // 19: headscale.v1.UpdateNodeRequest
	...
	(*GetUserResponse)(nil),          // 32: headscale.v1.GetUserResponse
	(*CreateUserResponse)(nil),       // 33: headscale.v1.CreateUserResponse
	(*RenameUserResponse)(nil),       // 34: headscale.v1.RenameUserResponse
	(*DeleteUserResponse)(nil),       // 35: headscale.v1.DeleteUserResponse
	(*ListUsersResponse)(nil),        // 36: headscale.v1.ListUsersResponse
	(*CreatePreAuthKeyResponse)(nil), // 37: headscale.v1.CreatePreAuthKeyResponse
	(*ExpirePreAuthKeyResponse)(nil), // 38: headscale.v1.ExpirePreAuthKeyResponse
	(*ListPreAuthKeysResponse)(nil),  // 39: headscale.v1.ListPreAuthKeysResponse
	(*DebugCreateNodeResponse)(nil),  // 40: headscale.v1.DebugCreateNodeResponse
	(*GetNodeResponse)(nil),          // 41: headscale.v1.GetNodeResponse
	(*SetTagsResponse)(nil),          // 42: headscale.v1.SetTagsResponse
	...
	(*BackfillNodeIPsResponse)(nil),  // 49: headscale.v1.BackfillNodeIPsResponse
	(*CreateNodeResponse)(nil),       // 50: headscale.v1.CreateNodeResponse
	(*UpdateNodeResponse)(nil),       // 51: headscale.v1.UpdateNodeResponse
	(*GetRoutesResponse)(nil),        // 52: headscale.v1.GetRoutesResponse
	(*EnableRouteResponse)(nil),      // 53: headscale.v1.EnableRouteResponse
	(*DisableRouteResponse)(nil),     // 54: headscale.v1.DisableRouteResponse
	(*GetNodeRoutesResponse)(nil),    // 55: headscale.v1.GetNodeRoutesResponse
	(*DeleteRouteResponse)(nil),      // 56: headscale.v1.DeleteRouteResponse
	...
	(*RefreshApiKeyResponse)(nil),    // 61: headscale.v1.RefreshApiKeyResponse
...
var file_headscale_v1_headscale_proto_depIdxs = []int32{
	...
	18, // 18: headscale.v1.HeadscaleService.CreateNode:input_type -> headscale.v1.CreateNodeRequest
	19, // 19: headscale.v1.HeadscaleService.UpdateNode:input_type -> headscale.v1.UpdateNodeRequest
	20, // 20: headscale.v1.HeadscaleService.GetRoutes:input_type -> headscale.v1.GetRoutesRequest
	21, // 21: headscale.v1.HeadscaleService.EnableRoute:input_type -> headscale.v1.EnableRouteRequest
	22, // 22: headscale.v1.HeadscaleService.DisableRoute:input_type -> headscale.v1.DisableRouteRequest
	23, // 23: headscale.v1.HeadscaleService.GetNodeRoutes:input_type -> headscale.v1.GetNodeRoutesRequest
	24, // 24: headscale.v1.HeadscaleService.DeleteRoute:input_type -> headscale.v1.DeleteRouteRequest
	25, // 25: headscale.v1.HeadscaleService.CreateApiKey:input_type -> headscale.v1.CreateApiKeyRequest
	26, // 26: headscale.v1.HeadscaleService.ExpireApiKey:input_type -> headscale.v1.ExpireApiKeyRequest
	27, // 27: headscale.v1.HeadscaleService.ListApiKeys:input_type -> headscale.v1.ListApiKeysRequest
	28, // 28: headscale.v1.HeadscaleService.DeleteApiKey:input_type -> headscale.v1.DeleteApiKeyRequest
	29, // 29: headscale.v1.HeadscaleService.RefreshApiKey:input_type -> headscale.v1.RefreshApiKeyRequest
	30, // 30: headscale.v1.HeadscaleService.GetPolicy:input_type -> headscale.v1.GetPolicyRequest
	31, // 31: headscale.v1.HeadscaleService.SetPolicy:input_type -> headscale.v1.SetPolicyRequest
	32, // 32: headscale.v1.HeadscaleService.GetUser:output_type -> headscale.v1.GetUserResponse
	33, // 33: headscale.v1.HeadscaleService.CreateUser:output_type -> headscale.v1.CreateUserResponse
	34, // 34: headscale.v1.HeadscaleService.RenameUser:output_type -> headscale.v1.RenameUserResponse
	35, // 35: headscale.v1.HeadscaleService.DeleteUser:output_type -> headscale.v1.DeleteUserResponse
	36, // 36: headscale.v1.HeadscaleService.ListUsers:output_type -> headscale.v1.ListUsersResponse
	37, // 37: headscale.v1.HeadscaleService.CreatePreAuthKey:output_type -> headscale.v1.CreatePreAuthKeyResponse
	38, // 38: headscale.v1.HeadscaleService.ExpirePreAuthKey:output_type -> headscale.v1.ExpirePreAuthKeyResponse
	39, // 39: headscale.v1.HeadscaleService.ListPreAuthKeys:output_type -> headscale.v1.ListPreAuthKeysResponse
	40, // 40: headscale.v1.HeadscaleService.DebugCreateNode:output_type -> headscale.v1.DebugCreateNodeResponse
	41, // 41: headscale.v1.HeadscaleService.GetNode:output_type -> headscale.v1.GetNodeResponse
	42, // 42: headscale.v1.HeadscaleService.SetTags:output_type -> headscale.v1.SetTagsResponse
	43, // 43: headscale.v1.HeadscaleService.RegisterNode:output_type -> headscale.v1.RegisterNodeResponse
	44, // 44: headscale.v1.HeadscaleService.DeleteNode:output_type -> headscale.v1.DeleteNodeResponse
	45, // 45: headscale.v1.HeadscaleService.ExpireNode:output_type -> headscale.v1.ExpireNodeResponse
	46, // 46: headscale.v1.HeadscaleService.RenameNode:output_type -> headscale.v1.RenameNodeResponse
	47, // 47: headscale.v1.HeadscaleService.ListNodes:output_type -> headscale.v1.ListNodesResponse
	48, // 48: headscale.v1.HeadscaleService.MoveNode:output_type -> headscale.v1.MoveNodeResponse
	49, // 49: headscale.v1.HeadscaleService.BackfillNodeIPs:output_type -> headscale.v1.BackfillNodeIPsResponse
	50, // 50: headscale.v1.HeadscaleService.CreateNode:output_type -> headscale.v1.CreateNodeResponse
	51, // 51: headscale.v1.HeadscaleService.UpdateNode:output_type -> headscale.v1.UpdateNodeResponse
	52, // 52: headscale.v1.HeadscaleService.GetRoutes:output_type -> headscale.v1.GetRoutesResponse
	53, // 53: headscale.v1.HeadscaleService.EnableRoute:output_type -> headscale.v1.EnableRouteResponse
	54, // 54: headscale.v1.HeadscaleService.DisableRoute:output_type -> headscale.v1.DisableRouteResponse
	55, // 55: headscale.v1.HeadscaleService.GetNodeRoutes:output_type -> headscale.v1.GetNodeRoutesResponse
	56, // 56: headscale.v1.HeadscaleService.DeleteRoute:output_type -> headscale.v1.DeleteRouteResponse
	57, // 57: headscale.v1.HeadscaleService.CreateApiKey:output_type -> headscale.v1.CreateApiKeyResponse
	58, // 58: headscale.v1.HeadscaleService.ExpireApiKey:output_type -> headscale.v1.ExpireApiKeyResponse
	59, // 59: headscale.v1.HeadscaleService.ListApiKeys:output_type -> headscale.v1.ListApiKeysResponse
	60, // 60: headscale.v1.HeadscaleService.DeleteApiKey:output_type -> headscale.v1.DeleteApiKeyResponse
	61, // 61: headscale.v1.HeadscaleService.RefreshApiKey:output_type -> headscale.v1.RefreshApiKeyResponse
	62, // 62: headscale.v1.HeadscaleService.GetPolicy:output_type -> headscale.v1.GetPolicyResponse
	63, // 63: headscale.v1.HeadscaleService.SetPolicy:output_type -> headscale.v1.SetPolicyResponse

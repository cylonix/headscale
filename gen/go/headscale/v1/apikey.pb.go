...
type ApiKey struct {
	...
	Network       string `protobuf:"bytes,8,opt,name=network,proto3" json:"network,omitempty"` // __END_CYLONIX_MOD__
...
type CreateApiKeyRequest struct {
	...
	ScopeValue    *string `protobuf:"bytes,6,opt,name=scope_value,json=scopeValue,proto3,oneof" json:"scope_value,omitempty"` // __END_CYLONIX_MOD__
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_headscale_v1_apikey_proto_rawDesc = "" +
	"\n" +
	"\x19headscale/v1/apikey.proto\x12\fheadscale.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17headscale/v1/user.proto\"\xc0\x02\n" +
	"\x06ApiKey\x12\x0e\n" +
	...
	"\x04user\x18\x06 \x01(\v2\x12.headscale.v1.UserR\x04user\x12\x1c\n" +
	"\tnamespace\x18\a \x01(\tR\tnamespace\x12\x18\n" +
	"\anetwork\x18\b \x01(\tR\anetwork\"\xb8\x02\n" +
	...
	"\x04user\x18\x03 \x01(\tH\x01R\x04user\x88\x01\x01\x12\x1d\n" +
	"\anetwork\x18\x04 \x01(\tH\x02R\anetwork\x88\x01\x01\x12\"\n" +
	"\n" +
	"scope_type\x18\x05 \x01(\tH\x03R\tscopeType\x88\x01\x01\x12$\n" +
	"\vscope_value\x18\x06 \x01(\tH\x04R\n" +
	"scopeValue\x88\x01\x01B\f\n" +
	"\n" +
	"_namespaceB\a\n" +
	"\x05_userB\n" +
	"\n" +
	...
	"\x14ExpireApiKeyResponse\"\xc7\x03\n" +
	...
	"\anetwork\x18\x04 \x01(\tH\x02R\anetwork\x88\x01\x01\x12 \n" +
	"\tfilter_by\x18\x05 \x01(\tH\x03R\bfilterBy\x88\x01\x01\x12&\n" +
	"\ffilter_value\x18\x06 \x01(\tH\x04R\vfilterValue\x88\x01\x01\x12\x1c\n" +
	"\asort_by\x18\a \x01(\tH\x05R\x06sortBy\x88\x01\x01\x12 \n" +
	"\tsort_desc\x18\b \x01(\tH\x06R\bsortDesc\x88\x01\x01\x12\x17\n" +
	"\x04page\x18\t \x01(\rH\aR\x04page\x88\x01\x01\x12\x1f\n" +
	"\bpageSize\x18\n" +
	" \x01(\rH\bR\bpageSize\x88\x01\x01B\a\n" +
	"\x05_userB\f\n" +
	"\n" +
	"_namespaceB\n" +
	"\n" +
	...
	"\bapi_keys\x18\x01 \x03(\v2\x14.headscale.v1.ApiKeyR\aapiKeys\x12\x14\n" +
	"\x05total\x18\x02 \x01(\rR\x05total\"=\n" +
	"\x13DeleteApiKeyRequest\x12\x16\n" +
	"\x06prefix\x18\x01 \x01(\tR\x06prefix\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x04R\x02id\"\x16\n" +
	"\x14DeleteApiKeyResponse\".\n" +
	"\x14RefreshApiKeyRequest\x12\x16\n" +
	"\x06prefix\x18\x01 \x01(\tR\x06prefix\"\x17\n" +
	"\x15RefreshApiKeyResponseB)Z'github.com/juanfont/headscale/gen/go/v1b\x06proto3"

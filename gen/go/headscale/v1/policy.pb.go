...
type SetPolicyRequest struct {
	...
	User          *string                `protobuf:"bytes,2,opt,name=user,proto3,oneof" json:"user,omitempty"`           // __CYLONIX_MOD__
...
func (x *SetPolicyRequest) GetUser() string {
	if x != nil && x.User != nil {
		return *x.User
	}
	return ""
...
func (x *SetPolicyRequest) GetNamespace() string {
...
func (x *SetPolicyRequest) GetNetwork() string {
...
type GetPolicyRequest struct {
	...
	Network       *string                `protobuf:"bytes,2,opt,name=network,proto3,oneof" json:"network,omitempty"`     // __CYLONIX_MOD__
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetPolicyRequest) GetNetwork() string {
	if x != nil && x.Network != nil {
		return *x.Network
	}
	return ""
...
var file_headscale_v1_policy_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa8, 0x01, 0x0a, 0x10, 0x53,
	...
	0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x17, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x88, 0x01, 0x01,
	...
	0x20, 0x01, 0x28, 0x09, 0x48, 0x02, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x88,
	0x01, 0x01, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x42, 0x0c, 0x0a, 0x0a, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x6e, 0x65,
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x66, 0x0a, 0x11, 0x53, 0x65, 0x74, 0x50, 0x6f, 0x6c, 0x69,
	...
	0x65, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x66, 0x0a,
	...
	0x28, 0x09, 0x52, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x39, 0x0a, 0x0a, 0x75, 0x70,
...
func file_headscale_v1_policy_proto_init() {
	...
	file_headscale_v1_policy_proto_msgTypes[0].OneofWrappers = []any{}
	file_headscale_v1_policy_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}

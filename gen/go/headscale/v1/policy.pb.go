...
type GetPolicyRequest struct {
	...
	Network       *string `protobuf:"bytes,2,opt,name=network,proto3,oneof" json:"network,omitempty"` // __END_CYLONIX_MOD__
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_headscale_v1_policy_proto_rawDesc = "" +
	"\n" +
	"\x19headscale/v1/policy.proto\x12\fheadscale.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa8\x01\n" +
	...
	"\anetwork\x18\x02 \x01(\tH\x01R\anetwork\x88\x01\x01B\f\n" +
	"\n" +
	"_namespaceB\n" +
	"\n" +
	"\b_network\"f\n" +
